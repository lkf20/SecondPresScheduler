    ...
    Tables: {
      ...
      class_classroom_mappings: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "class_classroom_mappings_class_id_fkey"
            columns: ["class_id"]
            isOneToOne: false
            referencedRelation: "class_groups"
            referencedColumns: ["id"]
      ...
      classroom_allowed_classes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "classroom_allowed_classes_class_id_fkey"
            columns: ["class_id"]
            isOneToOne: false
            referencedRelation: "class_groups"
            referencedColumns: ["id"]
      ...
      staffing_rules: {
        ...
        Relationships: [
          {
            foreignKeyName: "staffing_rules_class_id_fkey"
            columns: ["class_id"]
            isOneToOne: false
            referencedRelation: "class_groups"
            referencedColumns: ["id"]
      ...
      sub_class_preferences: {
        ...
        Relationships: [
          {
            foreignKeyName: "sub_class_preferences_class_id_fkey"
            columns: ["class_id"]
            isOneToOne: false
            referencedRelation: "class_groups"
            referencedColumns: ["id"]
