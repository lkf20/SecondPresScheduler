...
| **Admin (staff role)**                        | Office or administrative staff identified by the `ADMIN` role type. Not Baseline Permanent or Baseline Flex; mutually exclusive with those primary roles (a person is at most one of Permanent, Flex, or Admin). May still be eligible as a substitute when `is_sub` is set.                                                                                                                                                                                                                                                   |
