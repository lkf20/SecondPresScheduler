...
export const createTeacherScheduleSchema = z.object({
  ...
  class_id: z.string().uuid({ message: 'class_id must be a valid UUID' }).nullable().optional(),
  class_group_id: z
    .string()
...
export const resolveConflictSchema = z.object({
  ...
  target_class_id: z.string().uuid({ message: 'target_class_id must be a valid UUID' }).optional(),
