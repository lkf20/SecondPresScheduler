  ...
  try {
    ...
    if (!idValidation.success) {
      return NextResponse.json(
        { error: 'Invalid schedule cell ID format' },
        { status: 400 }
      )
    }
    ...
    return createErrorResponse(error, 'Failed to fetch schedule cell', 500, 'GET /api/schedule-cells/[id]')
  }
}
...
export async function PUT(
  ...
  try {
    ...
    return createErrorResponse(error, 'Failed to update schedule cell', 500, 'PUT /api/schedule-cells/[id]')
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return createErrorResponse(error, 'Failed to delete schedule cell', 500, 'DELETE /api/schedule-cells/[id]')
  }
}
