...
- [ ] **Edit temporary coverage:** Assignments with a staffing event show an Edit button. Saving an edit shows a confirm/scope dialog: single-shift shows a context-specific summary (classroom, day, time slot, date) with the change underlined and Confirm; multiple shifts with no past dates show only “All shifts in this assignment”; multiple shifts with past dates show “This shift only”, “This and following shifts”, and “All shifts in this assignment”. See [10-add-temporary-coverage.md](./10-add-temporary-coverage.md) §6.
