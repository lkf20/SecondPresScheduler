...
| [12-multi-classroom-absence-coverage.md](./12-multi-classroom-absence-coverage.md)         | Floater absence → per-classroom `coverage_request_shifts`; Assign Sub multi-room options; legacy null-classroom fallback warning.                           | Unit / integration |
